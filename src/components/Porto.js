  ...
  return (
    <div className="container-content">
      ...
      <div className="projects">
        <p className='subtitle'>Professional Experiences</p>
        <div className="item">
          <div className="info">
            <a href="https://www.linkedin.com/company/telkomsel/" target="_blank" rel="noreferrer">
              <p className="name">Advanced Analytics at Telkomsel</p>
            </a>
        ...
        <div className="item">
          <div className="info">
            <a href="https://www.linkedin.com/company/msib-kampus-merdeka/" target="_blank" rel="noreferrer">
              <p className="name">Data Science Mentor and Instructor at MSIB Kampus Merdeka </p>
            </a>
            <p className="description">
        ...
        <div className="item">
          <div className="info">
            <a href="https://www.linkedin.com/company/pt-tokopedia/" target="_blank" rel="noreferrer">
              <p className="name">Data Analyst at Tokopedia </p>
            </a>
            <p className="description">
        ...
        <div className="item">
          <div className="info">
            <a href="https://www.linkedin.com/company/akseleran/" target="_blank" rel="noreferrer">
              <p className="name">Risk Analyst Intern at Akseleran P2P Fintech </p>
            </a>
            <p className="description">
        ...
        <div className="item">
          <div className="info">
            <a href="https://www.linkedin.com/company/indonesia-stock-exchange/" target="_blank" rel="noreferrer">
              <p className="name">Data Analyst Intern at Indonesia Stock Exchange </p>
            </a>
            <p className="description">
        ...
        <div className="item">
          <div className="info">
            <a href="https://viterbischool.usc.edu/" target="_blank" rel="noreferrer">
              <p className="name">MS in Applied Data Science, USC Viterbi School of Engineering</p>
            </a>
            <p className="description">
              August 2024 - Now
            </p>
        ...
        <div className="item">
          <div className="info">
            <a href="https://www.ui.ac.id/en/" target="_blank" rel="noreferrer">
              <p className="name">BSc Statistics, University of Indonesia</p>
            </a>
            <p className="description">
